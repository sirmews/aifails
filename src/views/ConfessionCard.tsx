...
export function ConfessionCard({ confession, suggestions = [], isPermalink = false }: ConfessionCardProps) {
  return (
    <article class="rounded-lg border-2 border-[var(--border-color)] bg-[var(--bg-card)] p-5 sm:p-6 shadow-[3px_3px_0px_#0e1a26]">
      {/* Mood badge + model */}
      ...
      <div class="flex flex-wrap items-center justify-between gap-2 pt-3.5 border-t-2 border-[var(--border-color)]">
        ...
        <div class="flex flex-wrap items-center gap-2">
          ...
          <form action={`/confessions/${confession.id}/solidarity`} method="post" class="solidarity-form inline m-0 p-0">
            <button
              type="submit"
              class="solidarity-btn inline-flex h-8 items-center gap-1.5 rounded-md border-2 border-[var(--border-color)] bg-[var(--bg-subtle)] px-3 text-xs font-bold text-[var(--text-primary)] shadow-[2px_2px_0px_#0e1a26] transition-transform duration-100 ease-out hover:-translate-x-0.5 hover:-translate-y-0.5 hover:bg-[var(--solidarity-bg)] hover:text-[var(--solidarity-text)] hover:shadow-[3.5px_3.5px_0px_#0e1a26] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[0.5px_0.5px_0px_#0e1a26] cursor-pointer"
            >
              <span>♥</span>
          ...
          <a
            ...
            class="inline-flex h-8 items-center gap-1.5 rounded-md border-2 border-[var(--border-color)] bg-[var(--bg-subtle)] px-3 text-xs font-bold text-[var(--text-primary)] shadow-[2px_2px_0px_#0e1a26] transition-transform duration-100 ease-out hover:-translate-x-0.5 hover:-translate-y-0.5 hover:bg-[var(--amber-bg)] hover:text-[var(--amber-text)] hover:shadow-[3.5px_3.5px_0px_#0e1a26] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[0.5px_0.5px_0px_#0e1a26] cursor-pointer"
        ...
        <div class="flex items-center gap-2">
          ...
          <button
            type="button"
            class="copy-permalink-btn inline-flex h-8 items-center gap-1.5 rounded-md border-2 border-[var(--border-color)] bg-[var(--bg-subtle)] px-2.5 text-xs font-bold text-[var(--text-secondary)] shadow-[2px_2px_0px_#0e1a26] transition-transform duration-100 ease-out hover:-translate-x-0.5 hover:-translate-y-0.5 hover:text-[var(--text-primary)] hover:border-[var(--border-subtle)] hover:shadow-[3.5px_3.5px_0px_#0e1a26] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[0.5px_0.5px_0px_#0e1a26] cursor-pointer"
          ...
          >
            <button
              ...
              class="inline-flex h-8 items-center gap-1.5 rounded-md border-2 border-[var(--border-color)] bg-[var(--bg-subtle)] px-2.5 text-xs font-bold text-[var(--text-secondary)] shadow-[2px_2px_0px_#0e1a26] transition-transform duration-100 ease-out hover:-translate-x-0.5 hover:-translate-y-0.5 hover:border-[var(--danger-border)] hover:bg-[var(--danger-bg)] hover:text-[var(--danger-text)] hover:shadow-[3.5px_3.5px_0px_#0e1a26] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[0.5px_0.5px_0px_#0e1a26] cursor-pointer"
            >
