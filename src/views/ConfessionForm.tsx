        ...
        <form action="/confessions" method="post" class="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              required
              placeholder="I asked for a 2-line utility. I got an entire framework with 12 dependencies."
              rows={2}
              class="w-full resize-none rounded-md border-2 border-[var(--border-color)] bg-[var(--bg-subtle)] px-3.5 py-2.5 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:border-[var(--accent-primary)] focus:outline-none font-medium"
            ></textarea>
          </div>
          ...
          <div>
            ...
            <div class="relative" id="model-combobox-container">
              ...
              <div
                id="model-dropdown"
                class="hidden absolute left-0 right-0 top-full z-50 mt-1.5 max-h-64 overflow-y-auto rounded-md border-2 border-[var(--border-color)] bg-[var(--bg-card)] p-0 shadow-[4px_4px_0px_#0e1a26] text-xs"
              >
